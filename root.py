...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.sidebar_button_1 = customtkinter.CTkButton(self.sidebar_frame, command=self.sidebar_button_event, text= 'Hello')
        ...
        self.entry = customtkinter.CTkEntry(self, width=250, placeholder_text="Search patents")
        self.entry.grid(row=0, column=1, padx=(20, 0), pady=(20, 20), sticky="ew")

        self.main_button_1 = customtkinter.CTkButton(master=self, fg_color="transparent", border_width=2, text= 'ello', text_color=("gray10", "#DCE4EE"))
